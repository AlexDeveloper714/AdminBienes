        ...
        <div class="row" id="cliente">
            <div class="col-xs-12">
                ...
                <form method="post" action="control.php" enctype="multipart/form-data">
                    ...
                    <button type="button" class="btn" data-toggle="modal" data-target="#envioCliente">Enviar Cliente</button>
                    <div class="modal fade" id="envioCliente" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                    <h3><i class="fa fa-save fa"></i> Guardar Cambios</h3>
                                </div>
                                <div class="modal-body"><h3>¿Estas seguro de querer guardar los cambios?</h3></div>
                                <div class="modal-footer">
                                    <button type="submit" id="envioCl" name="enviarCliente" class="btn btn-primary">Guardar Cambios</button>
        ...
        <div class="row" id="activo">
            <div class="col-xs-12">
                ...
                <form method="post" action="control.php">
                    ...
                    <button type="button" class="btn" data-toggle="modal" data-target="#envioActivo">Enviar Activo</button>
                    <div class="modal fade" id="envioActivo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
